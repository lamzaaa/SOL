		...
		<div class="row">
			...
			<div class="wrapper-button d-flex justify-end">
				<a class="view-more">
					...
					<span>
						<xsl:value-of disable-output-escaping="yes" select="/NewsList/XTText"></xsl:value-of>
					</span>
		...
		<div class="col-lg-3 col-md-6">
			<div class="news-item zoom-img">
				...
				<div class="content-wrapper d-flex flex-column justify-between">
					<a class="title f-20 fw-700 color-main line-30 color-main lcl lcl-3" href="">
						<xsl:attribute name="href">
							<xsl:value-of select="Url"></xsl:value-of>
						</xsl:attribute>
						<xsl:attribute name="title">
					...
					<div class="desc f-16 fw-300 line-30 lcl lcl-9">
