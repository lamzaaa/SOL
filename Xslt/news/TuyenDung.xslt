						...
						<xsl:if test="ShowOption > 0">
							...
							<xsl:if test="floor(ShowOption div 2) mod 2 = 1">
								<div class="option new">
									<xsl:value-of select="/NewsList/NewText" disable-output-escaping="yes"></xsl:value-of>
								</div>
							</xsl:if>
							<xsl:if test="floor(ShowOption div 4) mod 2 = 1">
								<div class="option deadline">
									<xsl:value-of select="/NewsList/DeadLineText" disable-output-escaping="yes"></xsl:value-of>
								</div>
							</xsl:if>
						</xsl:if>
					</div>
